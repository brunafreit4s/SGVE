...
namespace SGVEapi.Migrations
{
    ...
    [Migration("20230515215502_AddEnderecoDataTableDb2")]
    partial class AddEnderecoDataTableDb2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SGVE_api.Models.Produtos", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 2L,
                            Custo = 1.5f,
                            DataCadastro = new DateTime(2023, 5, 15, 18, 55, 2, 560, DateTimeKind.Local).AddTicks(6682),
