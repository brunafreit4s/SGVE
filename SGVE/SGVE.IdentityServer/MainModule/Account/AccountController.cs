...
using SGVE.IdentityServer.MainModule.Account;
...
namespace IdentityServerHost.Quickstart.UI
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(
            ...
            UserManager<ApplicationUser> userManager,       /* É injetado pela class Program.cs */
            SignInManager<ApplicationUser> signInManager,   /* É injetado pela class Program.cs */
        ...
        public async Task<IActionResult> Login(LoginInputModel model, string button)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded) //_users.ValidateCredentials(model.Username, model.Password))
                {
